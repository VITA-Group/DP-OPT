"""OpenAI LLM access. Codes are mostly from https://github.com/keirp/automatic_prompt_engineer/blob/main/automatic_prompt_engineer/llm.py"""
...
class GPT_Forward(LLM):
    ...
    def __generate_text(self, prompt, n):
        ...
        config['n'] = n
        response = None
        print(f"### Query with config: {config}")
